const circeleSymbol = '<ion-icon name="logo-python"></ion-icon>';
const crossSymobl = '<ion-icon name="shield-half-outline">';
...
{   
    if (isGameRunning)
    {
        if (fields[parseInt(fieldId)] == "e")
        {
            ...
            document.getElementById(fieldId).innerHTML = circeleSymbol;
            checkForWinner();
            setCross();
        }
    }
...
function setCross()
{
    ...
    if (fields[parseInt(fieldId)] == "e")
    {
        ...
        document.getElementById(fieldId).innerHTML = crossSymobl;
        checkForWinner();
    }
    else
    {
...
function setWinner(winner, winningLine)
{
    ...
    if (winner == "o")
    {
        ...
        document.getElementById("card").style.backgroundColor = "lightgreen";
    }
    else if (winner == "x")
    {
        highlightWinner(winningLine);
    ...
    {
        document.getElementById("status").innerHTML  = "Es ist momentan Unentschieden";
    }
    
}
function highlightWinner(winningLine)
{
    document.getElementById(winningLine[0]).style.backgroundColor = "lightgreen";
    document.getElementById(winningLine[1]).style.backgroundColor = "lightgreen";
    document.getElementById(winningLine[2]).style.backgroundColor = "lightgreen";
}
